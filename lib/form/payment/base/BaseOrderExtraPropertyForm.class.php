...
/**
 * OrderExtraProperty form base class.
 *
 * @method OrderExtraProperty getObject() Returns the current form's model object
 *
 * @package    payment
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseOrderExtraPropertyForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('order_extra_property[%s]');
