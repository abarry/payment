...
class CreditCardTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lib.model.payment.map.CreditCardTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('BRAND', 'Brand', 'CHAR', true, 20, null);
        $this->addColumn('NUMBER', 'Number', 'VARCHAR', true, 255, null);
        $this->addColumn('EXPIRES_AT', 'ExpiresAt', 'VARCHAR', true, 4, null);
        $this->addColumn('OWNER', 'Owner', 'VARCHAR', true, 255, null);
        $this->addColumn('IS_SELECTED', 'IsSelected', 'BOOLEAN', false, 20, false);
