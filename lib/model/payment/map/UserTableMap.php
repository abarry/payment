...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lib.model.payment.map.UserTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('TYPE', 'Type', 'CHAR', false, 30, null);
    ...
    {
        $this->addRelation('CreditCard', 'CreditCard', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null, 'CreditCards');
    } // buildRelations()
