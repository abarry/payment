...
abstract class BaseOrderPeer {
    ...
    /** the column name for the SELLER_PSP_CONFIGURATION_ID field */
    const SELLER_PSP_CONFIGURATION_ID = 'order.SELLER_PSP_CONFIGURATION_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Reference', 'Amount', 'Hash', 'UserId', 'SellerPspConfigurationId', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'reference', 'amount', 'hash', 'userId', 'sellerPspConfigurationId', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::REFERENCE, self::AMOUNT, self::HASH, self::USER_ID, self::SELLER_PSP_CONFIGURATION_ID, self::CREATED_AT, self::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'REFERENCE', 'AMOUNT', 'HASH', 'USER_ID', 'SELLER_PSP_CONFIGURATION_ID', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'reference', 'amount', 'hash', 'user_id', 'seller_psp_configuration_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Reference' => 1, 'Amount' => 2, 'Hash' => 3, 'UserId' => 4, 'SellerPspConfigurationId' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'reference' => 1, 'amount' => 2, 'hash' => 3, 'userId' => 4, 'sellerPspConfigurationId' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::REFERENCE => 1, self::AMOUNT => 2, self::HASH => 3, self::USER_ID => 4, self::SELLER_PSP_CONFIGURATION_ID => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'REFERENCE' => 1, 'AMOUNT' => 2, 'HASH' => 3, 'USER_ID' => 4, 'SELLER_PSP_CONFIGURATION_ID' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'reference' => 1, 'amount' => 2, 'hash' => 3, 'user_id' => 4, 'seller_psp_configuration_id' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderPeer::REFERENCE);
            $criteria->addSelectColumn(OrderPeer::AMOUNT);
            $criteria->addSelectColumn(OrderPeer::HASH);
            $criteria->addSelectColumn(OrderPeer::USER_ID);
            $criteria->addSelectColumn(OrderPeer::SELLER_PSP_CONFIGURATION_ID);
            ...
            $criteria->addSelectColumn($alias . '.SELLER_PSP_CONFIGURATION_ID');
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // Invalidate objects in OrderExtraPropertyPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    /**
     * Returns the number of rows matching criteria, joining the related SellerPspConfiguration table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinSellerPspConfiguration(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderPeer::SELLER_PSP_CONFIGURATION_ID, SellerPspConfigurationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Order objects pre-filled with their SellerPspConfiguration objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinSellerPspConfiguration(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = SellerPspConfigurationPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = SellerPspConfigurationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    SellerPspConfigurationPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Order) to $obj2 (SellerPspConfiguration)
                $obj2->addOrder($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SellerPspConfigurationPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + SellerPspConfigurationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined SellerPspConfiguration rows

            $key2 = SellerPspConfigurationPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = SellerPspConfigurationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (Order) to the collection in $obj2 (SellerPspConfiguration)
                $obj2->addOrder($obj1);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(TransactionPeer::ORDER_ID, $obj->getId());
            $affectedRows += TransactionPeer::doDelete($criteria, $con);

            // delete related OrderExtraProperty objects
            $criteria = new Criteria(OrderExtraPropertyPeer::DATABASE_NAME);
            
            $criteria->add(OrderExtraPropertyPeer::ORDER_ID, $obj->getId());
            $affectedRows += OrderExtraPropertyPeer::doDelete($criteria, $con);
        }
