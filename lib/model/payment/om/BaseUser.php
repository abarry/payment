...
abstract class BaseUser extends BaseObject 
{
    ...
    /**
     * @var        PropelObjectCollection|CreditCard[] Collection to store aggregation of CreditCard objects.
     */
    ...
    public function setReference($v)
    {
        ...
        if ($this->reference !== $v) {
            $this->reference = $v;
            $this->modifiedColumns[] = UserPeer::REFERENCE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserPeer::REFERENCE)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collCreditCards) {
                $result['CreditCards'] = $this->collCreditCards->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPeer::REFERENCE)) $criteria->add(UserPeer::REFERENCE, $this->reference);
    ...
    public function initCreditCards($overrideExisting = true)
    {
        ...
        $this->collCreditCards = new PropelObjectCollection();
     ...
     * @return PropelObjectCollection|CreditCard[] List of CreditCard objects
     * @throws PropelException
     */
    public function getCreditCards($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collCreditCards || null !== $criteria) {
            if ($this->isNew() && null === $this->collCreditCards) {
                // return empty collection
                $this->initCreditCards();
            } else {
                $collCreditCards = CreditCardQuery::create(null, $criteria)
                    ->filterByUser($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    /**
     * Sets a collection of CreditCard objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param      PropelCollection $creditCards A Propel collection.
     * @param      PropelPDO $con Optional connection object
     */
    public function setCreditCards(PropelCollection $creditCards, PropelPDO $con = null)
    {
        $this->creditCardsScheduledForDeletion = $this->getCreditCards(new Criteria(), $con)->diff($creditCards);

        foreach ($this->creditCardsScheduledForDeletion as $creditCardRemoved) {
    ...
    public function countCreditCards(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        if (null === $this->collCreditCards || null !== $criteria) {
            if ($this->isNew() && null === $this->collCreditCards) {
                ...
                $query = CreditCardQuery::create(null, $criteria);
                if ($distinct) {
                    $query->distinct();
                }
    ...
    public function addCreditCard(CreditCard $l)
    {
        ...
        if (!$this->collCreditCards->contains($l)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	CreditCard $creditCard The creditCard object to add.
     */
    protected function doAddCreditCard($creditCard)
    {
    ...
    /**
     * @param	CreditCard $creditCard The creditCard object to remove.
     */
    public function removeCreditCard($creditCard)
    {
        if ($this->getCreditCards()->contains($creditCard)) {
            $this->collCreditCards->remove($this->collCreditCards->search($creditCard));
            ...
            $this->creditCardsScheduledForDeletion[]= $creditCard;
    ...
    public function clearAllReferences($deep = false)
    {
        ...
        if ($this->collCreditCards instanceof PropelCollection) {
            $this->collCreditCards->clearIterator();
        }
        $this->collCreditCards = null;
    }
