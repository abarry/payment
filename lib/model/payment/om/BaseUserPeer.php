...
abstract class BaseUserPeer {
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Reference', 'Type', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'reference', 'type', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::REFERENCE, self::TYPE, self::CREATED_AT, self::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'REFERENCE', 'TYPE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'reference', 'type', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Reference' => 1, 'Type' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'reference' => 1, 'type' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::REFERENCE => 1, self::TYPE => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'REFERENCE' => 1, 'TYPE' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'reference' => 1, 'type' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::REFERENCE);
    ...
    {
        // Invalidate objects in CreditCardPeer instance pool,
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related CreditCard objects
            $criteria = new Criteria(CreditCardPeer::DATABASE_NAME);
            
            $criteria->add(CreditCardPeer::USER_ID, $obj->getId());
            $affectedRows += CreditCardPeer::doDelete($criteria, $con);
        }
