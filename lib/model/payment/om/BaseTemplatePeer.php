...
abstract class BaseTemplatePeer {
    ...
    const SELLER_PSP_CONFIGURATION_ID = 'template.SELLER_PSP_CONFIGURATION_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Content', 'Subject', 'SellerPspConfigurationId', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'content', 'subject', 'sellerPspConfigurationId', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CONTENT, self::SUBJECT, self::SELLER_PSP_CONFIGURATION_ID, self::CREATED_AT, self::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CONTENT', 'SUBJECT', 'SELLER_PSP_CONFIGURATION_ID', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'content', 'subject', 'seller_psp_configuration_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Content' => 2, 'Subject' => 3, 'SellerPspConfigurationId' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'content' => 2, 'subject' => 3, 'sellerPspConfigurationId' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CONTENT => 2, self::SUBJECT => 3, self::SELLER_PSP_CONFIGURATION_ID => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CONTENT' => 2, 'SUBJECT' => 3, 'SELLER_PSP_CONFIGURATION_ID' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'content' => 2, 'subject' => 3, 'seller_psp_configuration_id' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TemplatePeer::SELLER_PSP_CONFIGURATION_ID);
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
		...
		{
		  call_user_func($sf_hook, 'BaseTemplatePeer', $criteria, $con);
		}
    ...
    public static function doCountJoinSellerPspConfiguration(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TemplatePeer::SELLER_PSP_CONFIGURATION_ID, SellerPspConfigurationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Template objects pre-filled with their SellerPspConfiguration objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinSellerPspConfiguration(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Template) to $obj2 (SellerPspConfiguration)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Template) to the collection in $obj2 (SellerPspConfiguration)
                $obj2->addTemplate($obj1);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseTemplatePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
