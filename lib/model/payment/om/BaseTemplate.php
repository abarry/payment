 ...
 */
abstract class BaseTemplate extends BaseObject 
{
    ...
    public function setSellerPspConfigurationId($v)
    {
        ...
        if ($this->seller_psp_configuration_id !== $v) {
            ...
            $this->modifiedColumns[] = TemplatePeer::SELLER_PSP_CONFIGURATION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->seller_psp_configuration_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            ...
            return $startcol + 7; // 7 = TemplatePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TemplatePeer::CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`CONTENT`';
        }
        if ($this->isColumnModified(TemplatePeer::SUBJECT)) {
            $modifiedColumns[':p' . $index++]  = '`SUBJECT`';
        }
        if ($this->isColumnModified(TemplatePeer::SELLER_PSP_CONFIGURATION_ID)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getSellerPspConfigurationId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setSellerPspConfigurationId($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TemplatePeer::SELLER_PSP_CONFIGURATION_ID)) $criteria->add(TemplatePeer::SELLER_PSP_CONFIGURATION_ID, $this->seller_psp_configuration_id);
    ...
    public function getSellerPspConfiguration(PropelPDO $con = null)
    {
        if ($this->aSellerPspConfiguration === null && ($this->seller_psp_configuration_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSellerPspConfiguration->addTemplates($this);
             */
        }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseTemplate:' . $name))
		{
