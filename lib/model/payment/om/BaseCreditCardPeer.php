...
abstract class BaseCreditCardPeer {
    ...
    const TM_CLASS = 'CreditCardTableMap';
    ...
    const ALIAS = 'credit_card.ALIAS';

    /** the column name for the BRAND field */
    const BRAND = 'credit_card.BRAND';

    /** the column name for the NUMBER field */
    const NUMBER = 'credit_card.NUMBER';

    /** the column name for the EXPIRES_AT field */
    const EXPIRES_AT = 'credit_card.EXPIRES_AT';

    /** the column name for the OWNER field */
    const OWNER = 'credit_card.OWNER';

    /** the column name for the IS_SELECTED field */
    const IS_SELECTED = 'credit_card.IS_SELECTED';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Alias', 'Brand', 'Number', 'ExpiresAt', 'Owner', 'IsSelected', 'UserId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'alias', 'brand', 'number', 'expiresAt', 'owner', 'isSelected', 'userId', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::ALIAS, self::BRAND, self::NUMBER, self::EXPIRES_AT, self::OWNER, self::IS_SELECTED, self::USER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ALIAS', 'BRAND', 'NUMBER', 'EXPIRES_AT', 'OWNER', 'IS_SELECTED', 'USER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'alias', 'brand', 'number', 'expires_at', 'owner', 'is_selected', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Alias' => 1, 'Brand' => 2, 'Number' => 3, 'ExpiresAt' => 4, 'Owner' => 5, 'IsSelected' => 6, 'UserId' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'alias' => 1, 'brand' => 2, 'number' => 3, 'expiresAt' => 4, 'owner' => 5, 'isSelected' => 6, 'userId' => 7, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ALIAS => 1, self::BRAND => 2, self::NUMBER => 3, self::EXPIRES_AT => 4, self::OWNER => 5, self::IS_SELECTED => 6, self::USER_ID => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ALIAS' => 1, 'BRAND' => 2, 'NUMBER' => 3, 'EXPIRES_AT' => 4, 'OWNER' => 5, 'IS_SELECTED' => 6, 'USER_ID' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'alias' => 1, 'brand' => 2, 'number' => 3, 'expires_at' => 4, 'owner' => 5, 'is_selected' => 6, 'user_id' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CreditCardPeer::ALIAS);
            $criteria->addSelectColumn(CreditCardPeer::BRAND);
            $criteria->addSelectColumn(CreditCardPeer::NUMBER);
            $criteria->addSelectColumn(CreditCardPeer::EXPIRES_AT);
            $criteria->addSelectColumn(CreditCardPeer::OWNER);
            $criteria->addSelectColumn(CreditCardPeer::IS_SELECTED);
            ...
            $criteria->addSelectColumn($alias . '.IS_SELECTED');
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
		...
		{
		  call_user_func($sf_hook, 'BaseCreditCardPeer', $criteria, $con);
		}
     ...
     *
     * @param      CreditCard $obj A CreditCard object.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to credit_card
    ...
    {
        $key = CreditCardPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = CreditCardPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + CreditCardPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = CreditCardPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CreditCardPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CreditCardPeer::addSelectColumns($criteria);
        $startcol = CreditCardPeer::NUM_HYDRATE_COLUMNS;
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CreditCardPeer::addSelectColumns($criteria);
        $startcol2 = CreditCardPeer::NUM_HYDRATE_COLUMNS;
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseCreditCardPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseCreditCardPeer::TABLE_NAME)) {
    ...
    {
        return CreditCardPeer::OM_CLASS;
    }
    ...
    /**
     * Performs an UPDATE on the database, given a CreditCard or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(CreditCardPeer::ID);
            if ($value) {
                $selectCriteria->add(CreditCardPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CreditCardPeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(CreditCardPeer::TABLE_NAME, $con, CreditCardPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            CreditCardPeer::clearInstancePool();
            CreditCardPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        return BasePeer::doValidate(CreditCardPeer::DATABASE_NAME, CreditCardPeer::TABLE_NAME, $columns);
    }
	...
	{
	  return array(array('alias', 'number'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseCreditCardPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
...
//
BaseCreditCardPeer::buildTableMap();
