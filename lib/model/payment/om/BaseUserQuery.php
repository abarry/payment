 ...
 * @method     UserQuery orderByReference($order = Criteria::ASC) Order by the reference column
 ...
 * @method     UserQuery groupByReference() Group by the reference column
 ...
 *
 * @method     UserQuery leftJoinCreditCard($relationAlias = null) Adds a LEFT JOIN clause to the query using the CreditCard relation
 * @method     UserQuery rightJoinCreditCard($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CreditCard relation
 * @method     UserQuery innerJoinCreditCard($relationAlias = null) Adds a INNER JOIN clause to the query using the CreditCard relation
 *
 ...
 * @method     User findOneByReference(string $reference) Return the first User filtered by the reference column
 ...
 * @method     array findByReference(string $reference) Return User objects filtered by the reference column
...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `REFERENCE`, `TYPE`, `CREATED_AT`, `UPDATED_AT` FROM `user` WHERE `ID` = :p0';
        try {
    ...
    public function filterByReference($reference = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserPeer::REFERENCE, $reference, $comparison);
    }
     ...
     *
     * @param   CreditCard|PropelObjectCollection $creditCard  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UserQuery The current query, for fluid interface
    ...
    public function filterByCreditCard($creditCard, $comparison = null)
    {
        if ($creditCard instanceof CreditCard) {
            return $this
                ->addUsingAlias(UserPeer::ID, $creditCard->getUserId(), $comparison);
        } elseif ($creditCard instanceof PropelObjectCollection) {
            return $this
                ->useCreditCardQuery()
                ->filterByPrimaryKeys($creditCard->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCreditCard() only accepts arguments of type CreditCard or PropelCollection');
        }
    }
